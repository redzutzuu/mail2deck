...
define("NC_BOARD", [ //default Board to use in case it's not sent via email
    "DEFAULT_BOARD" => "Support",
    "OA_BOARD" => "OA Support",
    "CA_BOARD" => "CA Support"
]);

define("SUBMITTER_ADDRESS", [
    "DOMAIN_OA" => "@oa",
    "DOMAIN_CA" => "@ca"
]);
...
define("ROCKETCHAT_WEBHOOK", ""); //define rocket chat webhook
